...
from
url = (0062)
http://www.cddgg.net/static/v2/js/box-slider-all.jquery.min.js -->
    <
html > < head > < meta
http - equiv = "Content-Type"
content = "text/html; charset=GBK" > < / head > < body > < pre
style = "word-wrap: break-word; white-space: pre-wrap;" > (function (i, f, r) {
        var g = {}, s = !0, p = {}, u = {
            speed: 800,
            timeout: 5E3,
            autoScroll: !1,
        ...
        i.jqBoxSlider = g;
        g.init = function (a) {
            var b = f.extend({}, u, a), d = g.slideAnimator(b.effect);
            return this.each(function () {
                var a = f(this), h = a.children(), e = f.extend({}, b);
                a.data("bssettings", e);
                e.slideAnimator = d;
        ...
        g.destroy = function () {
            return this.each(function () {
                var a = f(this), b = (a.data() || {}).bssettings;
        ...
        var v = function (a, b) {
            var d =
                f();
            null != b.next &amp;&amp; (d = d.add(f(b.next).on("click", {reverse: !1}, t)));
            ...
            if (null != d.autointv || b)if (d.autointv = clearInterval(d.autointv),
                    !b)return;
            d.autointv = setInterval(function () {
                n(c)
            }, d.timeout + d.speed)
        }, n = function (a, b, d) {
            var c = a.data("bssettings"), h = a.children(), e, k, j, g;
            ...
            a.hasClass("jbs-in-motion") || -1 === k || (j = h.eq(e), g = h.eq(k), a.addClass("jbs-in-motion"), "function" === typeof c.onbefore &amp;&amp; c.onbefore.call(a, j, g, e, k), f.extend(c, c.slideAnimator.transition(f.extend({
                $box: a,
                $slides: h, $currSlide: j, $nextSlide: g, reverse: d, currIndex: e, nextIndex: k
            ...
            f.each(c, function (h, e) {
                d.origCSS[b][e] = a.css(e)
            })
        }, x = function () {
            var a = document.body.style, b = "";
        ...
        i.jqBoxSlider.registerAnimator("blindDown,blindLeft",
            function () {
                var a = function (b, a) {
                    ...
                    var e = {backgroundImage: "url(" + b(a.$nextSlide) + ")"};
                    switch (a.effect) {
                        case "blindDown":
                            e.top = "0px";
                            break;
                ...
                return {
                    initialize: function (d, e, c) {
                        var j = f(document.createElement("div")), g = b(e.eq(0)), l, m = 0;
                        c.blindCount ||
                        (c.blindCount = 10);
                        ...
                        for (this._cacheOriginalCSS(e, "slides", c); m &lt; c.blindCount; ++m)l = m * c.blindSize, f(document.createElement("div")).css({
                            position: "absolute",
                            top: "0px",
                            left: l + "px",
                        ...
                        e.css({zIndex: 1, position: "absolute", top: 0, left: 0});
                        j.css({
                            position: "absolute",
                            top: "0px",
                            left: "0px",
        ...
        i.jqBoxSlider.registerAnimator("scrollVert3d,scrollHorz3d", function () {
            ...
            a.initialize = function (c, e, f) {
                var g = c.parent(), i = g.innerWidth(), l = g.innerHeight(), m = {
                    position: "absolute",
                    top: 0,
                    left: 0,
                    width: i,
                ...
                b ? (f.translateZ = "scrollVert3d" === f.effect ? l / 2 : i / 2, f.bsangle = 0, g.css(d + "perspective", f.perspective), g.css("overflow", "visible"), c.css(d + "transform-style", "preserve-3d"), c.css(d + "transform", "translate3d(0, 0, -" + f.translateZ + "px)"), e.eq(0).css(d + "transform", "rotate3d(0, 1, 0, 0deg) translate3d(0, 0, " +
                    f.translateZ + "px)"), setTimeout(function () {
                    a.reset(c, f)
            ...
            a.transition = function (a) {
                var e = a.bsangle + (a.reverse ? 90 : -90), f = "scrollVert3d" === a.effect;
                if (b)return 0 === e &amp;&amp; (e = a.reverse ? 360 : -360), a.$currSlide.css("z-index", 1), a.$slides.filter(function (b) {
                    return a.currIndex !== b
                }).css(d + "transform", "none").css("display", "none"), a.$nextSlide.css(d + "transform", c(e, f) + " translate3d(0, 0," + a.translateZ + "px)").css({
                    display: "block",
                    zIndex: 2
                }), a.$box.css(d + "transform", "translate3d(0, 0, -" + a.translateZ + "px) rotate3d(" + (f ? "1, 0, 0, " : "0, 1, 0, ") + e + "deg)"), 360 === Math.abs(e) &amp;&amp; (a.$box.css(d + "transform", "translate3d(0, 0, -" + a.translateZ + "px)"), e = 0), {bsangle: e};
            ...
            a.destroy = function (a, b) {
                var c = a.children(), d = a.parent();
                b.origCSS &amp;&amp; (a.css(b.origCSS.box), c.css(b.origCSS.slides), d.css(b.origCSS.viewport), delete b.bsangle,
                    delete b.translateZ)
            };
            var c = function (a, b) {
                switch (a) {
        ...
        i.jqBoxSlider.registerAnimator("scrollVert,scrollHorz", function () {
            var a = {
                initialize: function (b, d, c) {
                    ...
                    var d = a.$box, c = a.reverse, g = {}, e = {};
                    "scrollVert" === a.effect ? (e.top = (c ? d.height() : -d.height()) + "px", g.top = -parseInt(e.top, 10) + "px", d = {top: "0px"}) : (e.left = (c ? d.width() : -d.width()) + "px", g.left = -parseInt(e.left, 10) + "px", d = {left: "0px"});
                    a.$nextSlide.css(f.extend(e,
                        {display: "block"})).animate(d, a.speed);
