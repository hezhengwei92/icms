                ...
                onSelect: option.onSelect || function (files) {
                    ...
                    if (!option.auto) {
                        _this.find('.uploadbtn').on('click', function () {
                            ...
                            HTMLFILES.funUploadFile(getFile(index, files));
                        });
                    }
                    // 为删除文件按钮绑定删除文件事件
                    _this.find('.delfilebtn').on('click', function () {
                        var index = parseInt($(this).parents('li').attr('id'));
                        HTMLFILES.funDeleteFile(index);
                    });
