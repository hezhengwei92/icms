...
/**
 * EhCacheManager 改为vm单利模式
 *
 * @author jin E-mail： jin@westboy.net
 * @version 创建时间：2016年9月23日 下午11:38:44
 */
public class EhCacheManager implements CacheManager, Initializable, Destroyable {
     ...
     * one is not already provided.
     *
     * @param classpathLocation resource location of the config file used to create the
     *                          wrapped EhCache CacheManager instance.
     */
